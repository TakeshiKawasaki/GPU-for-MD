...
__global__ void calc_force_kernel(double*x_dev,double*y_dev,double *fx_dev,double *fy_dev,double *a_dev,double *L_dev,int *list_dev,double *gamma_dev){
...
__global__ void shear_affine(double *x_dev, double *y_dev,double *delta_gamma_dev,double *gamma_dev){
  int i_global = threadIdx.x + blockIdx.x*blockDim.x;
...
void FIRE(double *x_dev, double *y_dev,double  *vx_dev, double *vy_dev, double *fx_dev,double *fy_dev, double *a_dev,double *L_dev, int *list_dev, double *power_dev, double *alpha_dev, double *dt_dev, int *FIRE_gate_dev,int *FIRE_param_gate_dev, int *reduce_dev, int *remain_dev,double *gamma_dev){
  calc_force_kernel<<<NB,NT>>>(x_dev,y_dev,fx_dev,fy_dev,a_dev,L_dev,list_dev,gamma_dev);
...
int main(){
  double *x,*vx,*y,*vy,*x_dev,*vx_dev,*y_dev,*dx_dev,*dy_dev,*vy_dev,*a_dev,*fx_dev,*fy_dev,*power_dev,*L_dev,*deltaphi_dev,deltaphi;
  double *pot_dev,*pressure_dev,*stress_dev,*pot,*pressure,*stress;
  double *dt_dev,*alpha_dev,*phi_dev,phi;
  double gamma =0.,*gamma_dev,*delta_gamma_dev;
  ...
  while(gamma < 1.0){ 
    ...
    change_delta_gamma<<<1,1>>>(delta_gamma_dev,gamma_dev);
  }
